...
namespace VPFinal
{
    class Triangle : Figure
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            {
                g.FillRectangle(Brushes.Blue, rect.X + 1, rect.Y + 1, 19, 19);
        ...
        {
            if ((GetForm() == 2 && location.Y + 21 < 396) || (GetForm() != 2 && location.Y + 42 < 396))
            {
                for (int i = 0; i < 4; ++i)
                {
                    rectangle[i].Y += 7;
        ...
        {
            if ((GetForm() == 3 && location.X + 21 > 5) || (GetForm() != 3 && location.X > 5))
            {
                for (int i = 0; i < 4; ++i)
                {
                    rectangle[i].X -= 21;
        ...
        {
            if ((GetForm() == 1 && location.X + 42 < 215) || (GetForm() != 1 && location.X + 63 < 215))
            {
                for (int i = 0; i < 4; ++i)
                {
                    rectangle[i].X += 21;
        ...
        public override void Rotate()
        {
            ...
            if (i == 0)
            {
                ...
                rectangle[3] = new Rectangle(location.X, location.Y, 21, 21);
